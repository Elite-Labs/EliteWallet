...
Java_com_elitewallet_monero_MoneroApi_setNodeAddressJNI(
        JNIEnv *env,
        jobject inst,
        jstring uri,
        jstring login,
...
JNIEXPORT void JNICALL
Java_com_elitewallet_monero_MoneroApi_connectToNodeJNI(
        JNIEnv *env,
        jobject inst) {
    char *error;
...
JNIEXPORT void JNICALL
Java_com_elitewallet_monero_MoneroApi_startSyncJNI(
        JNIEnv *env,
        jobject inst) {
    start_refresh();
}
...
JNIEXPORT void JNICALL
Java_com_elitewallet_monero_MoneroApi_loadWalletJNI(
        JNIEnv *env,
        jobject inst,
        jstring path,
        jstring password) {
