...
Java_com_elitewallet_wownero_WowneroApi_setNodeAddressJNI(
        JNIEnv *env,
        jobject inst,
        jstring uri,
        jstring login,
...
JNIEXPORT void JNICALL
Java_com_elitewallet_wownero_WowneroApi_connectToNodeJNI(
        JNIEnv *env,
        jobject inst) {
    char *error;
...
JNIEXPORT void JNICALL
Java_com_elitewallet_wownero_WowneroApi_startSyncJNI(
        JNIEnv *env,
        jobject inst) {
    start_refresh();
}
...
JNIEXPORT void JNICALL
Java_com_elitewallet_wownero_WowneroApi_loadWalletJNI(
        JNIEnv *env,
        jobject inst,
        jstring path,
        jstring password) {
