...
Pod::Spec.new do |s|
  ...
  s.homepage         = 'elitewallet.sc'
  s.license          = { :file => '../LICENSE' }
  s.author           = { 'EliteWallet' => 'support@elitewallet.sc' }
  s.source           = { :path => '.' }
  ...
  s.subspec 'Wownero-seed' do |wownero_seed|
    wownero_seed.preserve_paths = '../../../../../cw_shared_external/ios/External/ios/include/**/*.h',
    wownero_seed.vendored_libraries =  '../../../../../cw_shared_external/ios/External/ios/lib/libwownero-seed.a',
