...
import 'package:ew_solana/default_spl_tokens.dart';
import 'package:ew_solana/file.dart';
import 'package:ew_solana/solana_balance.dart';
import 'package:ew_solana/solana_client.dart';
import 'package:ew_solana/solana_exceptions.dart';
import 'package:ew_solana/solana_transaction_credentials.dart';
import 'package:ew_solana/solana_transaction_history.dart';
import 'package:ew_solana/solana_transaction_info.dart';
import 'package:ew_solana/solana_transaction_model.dart';
import 'package:ew_solana/solana_wallet_addresses.dart';
...
abstract class SolanaWalletBase
  ...
  SolanaWalletBase({
    ...
    if (!EliteHive.isAdapterRegistered(SPLToken.typeId)) {
      EliteHive.registerAdapter(SPLTokenAdapter());
    }
  ...
  Future<void> init() async {
    ...
    splTokensBox = await EliteHive.openBox<SPLToken>(boxName);
