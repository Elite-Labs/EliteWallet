...
# Run `pod lib lint ew_haven.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'ew_haven'
  s.version          = '0.0.1'
  s.summary          = 'Elite Wallet Haven'
  s.description      = 'Elite Wallet wrapper over Haven project'
  s.homepage         = 'https://elitewallet.sc'
  s.license          = { :file => '../LICENSE' }
  s.author           = { 'Elite Wallet' => 'info@elitewallet.sc' }
  s.source           = { :path => '.' }
