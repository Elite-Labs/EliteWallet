...
import 'package:ew_ethereum/pending_ethereum_transaction.dart';
...
import 'package:ew_ethereum/.secrets.g.dart' as secrets;
  ...
  Future<bool> connect(Node node, SettingsStore settingsStore) async {
    try {
      ...
      if (settingsStore.proxyEnabled) {
        ...
        _httpClient = ioc.IOClient(tempClient);
      }

      _client = Web3Client(nodeUri.toString(), _httpClient);
