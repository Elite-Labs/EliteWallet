...
import 'package:ew_ethereum/default_erc20_tokens.dart';
import 'package:ew_ethereum/erc20_balance.dart';
...
import 'package:ew_ethereum/ethereum_transaction_history.dart';
import 'package:ew_ethereum/ethereum_transaction_info.dart';
import 'package:ew_ethereum/ethereum_transaction_model.dart';
import 'package:ew_ethereum/ethereum_transaction_priority.dart';
import 'package:ew_ethereum/ethereum_wallet_addresses.dart';
import 'package:ew_ethereum/file.dart';
...
abstract class EthereumWalletBase
  ...
  @action
  @override
  Future<void> connectToNode({required Node node, required SettingsStore settingsStore}) async {
    try {
      syncStatus = ConnectingSyncStatus();

      final isConnected = await _client.connect(node, settingsStore);
