...
import 'package:ew_nano/file.dart';
import 'package:ew_core/nano_account.dart';
import 'package:ew_nano/nano_balance.dart';
import 'package:ew_nano/nano_client.dart';
import 'package:ew_nano/nano_transaction_credentials.dart';
import 'package:ew_nano/nano_transaction_history.dart';
import 'package:ew_nano/nano_transaction_info.dart';
import 'package:ew_nano/nano_wallet_keys.dart';
import 'package:ew_nano/pending_nano_transaction.dart';
import 'package:mobx/mobx.dart';
import 'dart:async';
import 'package:ew_nano/nano_wallet_addresses.dart';
...
abstract class NanoWalletBase
  ...
  NanoWalletBase({
    ...
    if (!EliteHive.isAdapterRegistered(NanoAccount.typeId)) {
      EliteHive.registerAdapter(NanoAccountAdapter());
    }
  }
