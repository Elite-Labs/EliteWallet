...
class CryptoCurrency extends EnumerableItem<int> with Serializable<int> implements Currency {
  ...
  static const wow = CryptoCurrency(title: 'WOW', fullName: 'Wownero', raw: 62, name: 'wow', iconPath: 'assets/images/wownero_icon.png', decimals: 12);
  static const btcln = CryptoCurrency(title: 'BTC', tag: 'LN', fullName: 'Bitcoin Lightning Network', raw: 63, name: 'btcln', iconPath: 'assets/images/btc.png', decimals: 8);
  static const shib = CryptoCurrency(title: 'SHIB', tag: 'ETH', fullName: 'Shiba Inu', raw: 64, name: 'shib', iconPath: 'assets/images/shib_icon.png', decimals: 18);
  static const aave = CryptoCurrency(title: 'AAVE', tag: 'ETH', fullName: 'Aave', raw: 65, name: 'aave', iconPath: 'assets/images/aave_icon.png', decimals: 18);
  ...
  static const bat = CryptoCurrency(title: 'BAT', tag: 'ETH', fullName: 'Basic Attention Token', raw: 67, name: 'bat', iconPath: 'assets/images/bat_icon.png', decimals: 18);
  static const comp = CryptoCurrency(title: 'COMP', tag: 'ETH', fullName: 'Compound', raw: 68, name: 'comp', iconPath: 'assets/images/comp_icon.png', decimals: 18);
  static const cro = CryptoCurrency(title: 'CRO', tag: 'ETH', fullName: 'Crypto.com Cronos', raw: 69, name: 'cro', iconPath: 'assets/images/cro_icon.png', decimals: 8);
  static const ens = CryptoCurrency(title: 'ENS', tag: 'ETH', fullName: 'Ethereum Name Service', raw: 70, name: 'ens', iconPath: 'assets/images/ens_icon.png', decimals: 18);
  static const ftm = CryptoCurrency(title: 'FTM', tag: 'ETH', fullName: 'Fantom', raw: 71, name: 'ftm', iconPath: 'assets/images/ftm_icon.png', decimals: 18);
  static const frax = CryptoCurrency(title: 'FRAX', tag: 'ETH', fullName: 'Frax', raw: 72, name: 'frax', iconPath: 'assets/images/frax_icon.png', decimals: 18);
  static const gusd = CryptoCurrency(title: 'GUSD', tag: 'ETH', fullName: 'Gemini USD', raw: 73, name: 'gusd', iconPath: 'assets/images/gusd_icon.png', decimals: 2);
  static const gtc = CryptoCurrency(title: 'GTC', tag: 'ETH', fullName: 'Gitcoin', raw: 74, name: 'gtc', iconPath: 'assets/images/gtc_icon.png', decimals: 18);
  static const grt = CryptoCurrency(title: 'GRT', tag: 'ETH', fullName: 'The Graph', raw: 75, name: 'grt', iconPath: 'assets/images/grt_icon.png', decimals: 18);
  static const ldo = CryptoCurrency(title: 'LDO', tag: 'ETH', fullName: 'Lido DAO', raw: 76, name: 'ldo', iconPath: 'assets/images/ldo_icon.png', decimals: 18);
  static const nexo = CryptoCurrency(title: 'NEXO', tag: 'ETH', fullName: 'Nexo', raw: 77, name: 'nexo', iconPath: 'assets/images/nexo_icon.png', decimals: 18);
  static const cake = CryptoCurrency(title: 'CAKE', tag: 'BSC', fullName: 'PancakeSwap', raw: 78, name: 'cake', iconPath: 'assets/images/cake_icon.png', decimals: 18);
  static const pepe = CryptoCurrency(title: 'PEPE', tag: 'ETH', fullName: 'Pepe', raw: 79, name: 'pepe', iconPath: 'assets/images/pepe_icon.png', decimals: 18);
  static const storj = CryptoCurrency(title: 'STORJ', tag: 'ETH', fullName: 'Storj', raw: 80, name: 'storj', iconPath: 'assets/images/storj_icon.png', decimals: 8);
  static const tusd = CryptoCurrency(title: 'TUSD', tag: 'ETH', fullName: 'TrueUSD', raw: 81, name: 'tusd', iconPath: 'assets/images/tusd_icon.png', decimals: 18);
  static const wbtc = CryptoCurrency(title: 'WBTC', tag: 'ETH', fullName: 'Wrapped Bitcoin', raw: 82, name: 'wbtc', iconPath: 'assets/images/wbtc_icon.png', decimals: 8);
  static const weth = CryptoCurrency(title: 'WETH', tag: 'ETH', fullName: 'Wrapped Ethereum', raw: 83, name: 'weth', iconPath: 'assets/images/weth_icon.png', decimals: 18);
  static const zrx = CryptoCurrency(title: 'ZRX', tag: 'ETH', fullName: '0x Protocol', raw: 84, name: 'zrx', iconPath: 'assets/images/zrx_icon.png', decimals: 18);
  static const dydx = CryptoCurrency(title: 'DYDX', tag: 'ETH', fullName: 'dYdX', raw: 85, name: 'dydx', iconPath: 'assets/images/dydx_icon.png', decimals: 18);
  static const steth = CryptoCurrency(title: 'STETH', tag: 'ETH', fullName: 'Lido Staked Ethereum', raw: 86, name: 'steth', iconPath: 'assets/images/steth_icon.png', decimals: 18);
  static const banano = CryptoCurrency(title: 'BAN', fullName: 'Banano', raw: 87, name: 'banano', iconPath: 'assets/images/nano_icon.png', decimals: 29);
  static const usdtPoly = CryptoCurrency(title: 'USDT', tag: 'POLY', fullName: 'Tether USD (PoS)', raw: 88, name: 'usdtpoly', iconPath: 'assets/images/usdt_icon.png', decimals: 6);
  static const usdcEPoly = CryptoCurrency(title: 'USDC.E', tag: 'POLY', fullName: 'USD Coin (PoS)', raw: 89, name: 'usdcepoly', iconPath: 'assets/images/usdc_icon.png', decimals: 6);
  static const kaspa = CryptoCurrency(title: 'KAS', fullName: 'Kaspa', raw: 90, name: 'kas', iconPath: 'assets/images/kaspa_icon.png', decimals: 8);
  static const digibyte = CryptoCurrency(title: 'DGB', fullName: 'DigiByte', raw: 91, name: 'dgb', iconPath: 'assets/images/digibyte.png', decimals: 8);
  static const usdtSol = CryptoCurrency(title: 'USDT', tag: 'SOL', fullName: 'USDT Tether', raw: 92, name: 'usdtsol', iconPath: 'assets/images/usdt_icon.png', decimals: 6);
