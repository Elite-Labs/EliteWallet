package sc.elitewallet.ew_wownero
...
class EwWowneroPlugin: FlutterPlugin, MethodCallHandler {
    companion object {
        //    val wowneroApi = WowneroApi()
        val main = Handler(Looper.getMainLooper());

        init {
            System.loadLibrary("ew_wownero")
        }

        @JvmStatic
        fun registerWith(registrar: Registrar) {
            val channel = MethodChannel(registrar.messenger(), "ew_wownero")
            channel.setMethodCallHandler(EwWowneroPlugin())
        }
    }
    ...
    override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        channel = MethodChannel(flutterPluginBinding.binaryMessenger, "ew_wownero")
