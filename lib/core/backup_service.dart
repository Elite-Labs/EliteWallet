...
class BackupService {
  ...
  Future<void> _importPreferencesDump() async {
    ...
    await _sharedPreferences.setBool(
        ...
        data[PreferencesKey.proxyEnabledKey] as bool);
    await _sharedPreferences.setString(
        PreferencesKey.proxyIPAddressKey,
        data[PreferencesKey.proxyIPAddressKey] as String);
    await _sharedPreferences.setString(
        PreferencesKey.proxyPortKey,
        data[PreferencesKey.proxyPortKey] as String);
    await _sharedPreferences.setBool(
        PreferencesKey.proxyAuthenticationEnabledKey,
        data[PreferencesKey.proxyAuthenticationEnabledKey] as bool);
    await _sharedPreferences.setString(
        PreferencesKey.proxyUsernameKey,
        data[PreferencesKey.proxyUsernameKey] as String);
    await _sharedPreferences.setString(
        PreferencesKey.proxyPasswordKey,
        data[PreferencesKey.proxyPasswordKey] as String);
    await _sharedPreferences.setBool(
        PreferencesKey.portScanEnabledKey,
        data[PreferencesKey.portScanEnabledKey] as bool);
    ...
    await _sharedPreferences.setString(PreferencesKey.cryptoPriceProvider,
        data[PreferencesKey.cryptoPriceProvider] as String);
