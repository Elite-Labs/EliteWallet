...
class EWMoneroAccountList extends MoneroAccountList {
  EWMoneroAccountList(this._wallet);
...
class EWMoneroSubaddressList extends MoneroSubaddressList {
  EWMoneroSubaddressList(this._wallet);
...
class EWMoneroWalletDetails extends MoneroWalletDetails {
  EWMoneroWalletDetails(this._wallet);
...
class EWMonero extends Monero {
  @override
  MoneroAccountList getAccountList(Object wallet) => EWMoneroAccountList(wallet);

  @override
  MoneroSubaddressList getSubaddressList(Object wallet) => EWMoneroSubaddressList(wallet);
  ...
  @override
  MoneroWalletDetails getMoneroWalletDetails(Object wallet) => EWMoneroWalletDetails(wallet);

  @override
  int getHeightByDate({required DateTime date}) => getMoneroHeightByDate(date: date);
