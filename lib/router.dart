...
import 'package:elite_wallet/entities/wallet_nft_response.dart';
...
import 'package:elite_wallet/src/screens/dashboard/pages/nft_details_page.dart';
...
import 'package:elite_wallet/src/screens/restore/sweeping_wallet_page.dart';
...
import 'package:elite_wallet/src/screens/dashboard/desktop_widgets/desktop_dashboard_actions.dart';
...
import 'package:elite_wallet/src/screens/settings/desktop_settings/desktop_settings_page.dart';
...
import 'package:elite_wallet/src/screens/new_wallet/advanced_privacy_settings_page.dart';
...
import 'package:elite_wallet/src/screens/new_wallet/new_wallet_page.dart';
...
import 'package:elite_wallet/src/screens/disclaimer/disclaimer_page.dart';
...
import 'package:elite_wallet/src/screens/welcome/create_welcome_page.dart';
...
Route<dynamic> createRoute(RouteSettings settings) {
  ...
  switch (settings.name) {
          ...
          builder: (_) => getIt.get<NewWalletTypePage>(
              param1: [(BuildContext context, WalletType type) =>
                  Navigator.of(context)
                      .pushNamed(Routes.newWallet, arguments: type), true]));
    ...
    case Routes.restoreWalletType:
      return CupertinoPageRoute<void>(
          builder: (_) => getIt.get<NewWalletTypePage>(
              param1: [(BuildContext context, WalletType type) =>
                  Navigator.of(context)
                      .pushNamed(Routes.restoreWallet, arguments: type), false]));
    ...
    case Routes.proxySettings: {
      return MaterialPageRoute<void>(
          builder: (_) => getIt.get<ProxySettingsPage>(
              param1: settings.arguments as List<List<SettingsListItem>>));
    }
