...
import 'package:elite_wallet/view_model/settings/version_list_item.dart';
import 'package:elite_wallet/view_model/settings/picker_list_item.dart';
      ...
      [
        ...
        RegularListItem(
            ...
            handler: (BuildContext context) =>
                Navigator.of(context).pushNamed(Routes.proxySettings),
        ),
        PickerListItem(
            ...
            selectedItem: () => _settingsStore.cryptoPriceProvider,
            onItemSelected: (String provider) {
              _settingsStore.cryptoPriceProvider = provider;
            },
