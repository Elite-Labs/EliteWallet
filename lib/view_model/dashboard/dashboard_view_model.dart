...
abstract class DashboardViewModelBase with Store {
        ...
        filterItems = {
          ...
          S.current.trades: [
            ...
            FilterItem(
                ...
                onChanged: () =>
                    tradeFilterStore.toggleDisplayExchange(ExchangeProviderDescription.majesticBank)),
            FilterItem(
                value: () => tradeFilterStore.displayXchangeMe,
                caption: ExchangeProviderDescription.xchangeme.title,
                onChanged: () =>
                    tradeFilterStore.toggleDisplayExchange(ExchangeProviderDescription.xchangeme)),
          ]
        },
        subname = '',
  ...
  Future<List<String>> checkAffectedWallets() async {
    ...
    final vulnerableSeedsString = await rootBundle
        .loadString('assets/text/elitewallet_weak_bitcoin_seeds_hashed_sorted_version1.txt');
