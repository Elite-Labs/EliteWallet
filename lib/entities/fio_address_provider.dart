...
class FioAddressProvider {
  ...
  static Future<bool> checkAvail(
    String fioAddress, SettingsStore settingsStore) async {
  ...
  static Future<String> getPubAddress(
    String fioAddress, String token, SettingsStore settingsStore) async {
