...
import 'package:elite_wallet/src/widgets/discount_badge.dart';
...
class IoniaBuyGiftCardDetailPage extends BasePage {
  ...
  Widget middle(BuildContext context) {
    return Text(
      ...
      style: textMediumSemiBold(color: Theme.of(context).extension<EliteTextTheme>()!.titleColor),
    );
  }
...
class TipButton extends StatelessWidget {
  ...
  Color captionTextColor(BuildContext context) {
    if (isDark(context)) {
      return Theme.of(context).extension<EliteTextTheme>()!.titleColor;
    }
  ...
  Color? backgroundColor(BuildContext context) {
    if (isDark(context)) {
      return isSelected
        ? null
        : Theme.of(context).extension<EliteTextTheme>()!.titleColor.withOpacity(0.01);
    }

    return isSelected
        ? null
        : Theme.of(context).extension<EliteTextTheme>()!.titleColor.withOpacity(0.1);
  }
