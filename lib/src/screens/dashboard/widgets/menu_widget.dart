import 'package:elite_wallet/src/widgets/setting_action_button.dart';
import 'package:elite_wallet/src/widgets/setting_actions.dart';
...
class MenuWidgetState extends State<MenuWidget> {
  MenuWidgetState()
      : this.menuWidth = 0,
        ...
        this.wowneroIcon = Image.asset('assets/images/wownero_menu.png'),
  ...
  Widget build(BuildContext context) {
    ...
    moneroIcon = Image.asset('assets/images/monero_menu.png',
        color: Theme.of(context).extension<EliteMenuTheme>()!.iconColor);
      ...
      children: <Widget>[
        ...
        Expanded(
          child: ClipRRect(
            ...
            child: Container(
              color: Theme.of(context).extension<EliteMenuTheme>()!.backgroundColor,
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(colors: [
                          Theme.of(context).extension<EliteMenuTheme>()!.headerFirstGradientColor,
                          Theme.of(context).extension<EliteMenuTheme>()!.headerSecondGradientColor,
