...
class StandardCheckbox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final boxBorder = Border.all(
        color: borderColor ?? Theme.of(context).extension<EliteTextTheme>()!.secondaryTextColor, width: 1.0);
          ...
          if (caption.isNotEmpty)
            Padding(
                ...
                child: Text(
                  caption,
                  style: TextStyle(
                      fontSize: 16.0, color: Theme.of(context).extension<EliteTextTheme>()!.titleColor),
                ))
        ],
      ),
    );
