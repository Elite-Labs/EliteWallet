...
class EWHavenAccountList extends HavenAccountList {
	EWHavenAccountList(this._wallet);
...
class EWHavenSubaddressList extends MoneroSubaddressList {
	EWHavenSubaddressList(this._wallet);
	final Object _wallet;
...
class EWHavenWalletDetails extends HavenWalletDetails {
	EWHavenWalletDetails(this._wallet);
	final Object _wallet;
...
class EWHaven extends Haven {
  @override
  HavenAccountList getAccountList(Object wallet) {
		return EWHavenAccountList(wallet);
	}

	@override
	MoneroSubaddressList getSubaddressList(Object wallet) {
		return EWHavenSubaddressList(wallet);
	}
  ...
  @override
	HavenWalletDetails getMoneroWalletDetails(Object wallet) {
		return EWHavenWalletDetails(wallet);
	}
