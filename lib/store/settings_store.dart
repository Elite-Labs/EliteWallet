...
import 'package:elite_wallet/entities/provider_types.dart';
...
import 'package:elite_wallet/entities/seed_phrase_length.dart';
import 'package:elite_wallet/entities/seed_type.dart';
...
abstract class SettingsStoreBase with Store {
  SettingsStoreBase(
    ...
    reaction(
        ...
        (Elite2FAPresetsOptions selectedElite2FAPreset) => secureStorage.write(
            key: SecureKey.selectedElite2FAPreset,
            value: selectedElite2FAPreset.serialize().toString()));
