...
Future setup(
  ...
  getIt.registerFactory(() => ConnectionSyncPage(getIt.get<NodeListViewModel>(), getIt.get<DashboardViewModel>(), getIt.get<SettingsStore>()));
  ...
  getIt.registerFactoryParam<NewWalletTypePage, List, void>(
      (param1, _) =>
        NewWalletTypePage(onTypeSelected: param1[0], isNew: param1[1]));
