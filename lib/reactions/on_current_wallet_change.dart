...
import 'package:elite_wallet/reactions/check_connection.dart';
import 'package:elite_wallet/reactions/on_wallet_sync_status_change.dart';
...
void startCurrentWalletChangeReaction(AppStore appStore,
  ...
  _onCurrentWalletChangeReaction = reaction((_) => appStore.wallet, (WalletBase<
    ...
    try {
      ...
      await wallet.connectToNode(node: node, settingsStore: settingsStore);
