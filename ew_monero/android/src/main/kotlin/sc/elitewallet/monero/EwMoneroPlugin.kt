...
class EwMoneroPlugin: MethodCallHandler {
  companion object {
//    val moneroApi = MoneroApi()
    val main = Handler(Looper.getMainLooper());

    init {
      System.loadLibrary("ew_monero")
    }

    @JvmStatic
    fun registerWith(registrar: Registrar) {
      val channel = MethodChannel(registrar.messenger(), "ew_monero")
      channel.setMethodCallHandler(EwMoneroPlugin())
    }
  }
