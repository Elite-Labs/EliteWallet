...
import 'package:ew_monero/api/wallet_manager.dart' as monero_wallet_manager;
...
class MoneroWalletService extends WalletService<MoneroNewWalletCredentials,
    ...
    try {
      ...
      if (credentials.isPolyseed) {
        ...
        final heightOverride =
            getMoneroHeightByDate(date: DateTime.now().subtract(Duration(days: 2)));
  ...
  Future<MoneroWallet> _restoreFromPolyseed(
    ...
    final height = overrideHeight ??
        getMoneroHeightByDate(date: DateTime.fromMillisecondsSinceEpoch(polyseed.birthday * 1000));
