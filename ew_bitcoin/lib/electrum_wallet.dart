...
import 'package:ew_bitcoin/address_to_output_script.dart';
...
import 'package:ew_bitcoin/electrum_transaction_history.dart';
import 'package:ew_bitcoin/bitcoin_transaction_no_inputs_exception.dart';
import 'package:ew_bitcoin/bitcoin_transaction_priority.dart';
import 'package:ew_bitcoin/bitcoin_transaction_wrong_balance_exception.dart';
import 'package:ew_bitcoin/bitcoin_unspent.dart';
import 'package:ew_bitcoin/bitcoin_wallet_keys.dart';
import 'package:ew_bitcoin/file.dart';
import 'package:ew_bitcoin/pending_bitcoin_transaction.dart';
...
abstract class ElectrumWalletBase extends WalletBase<ElectrumBalance,
  ...
  Future<void> connectToNode({
    ...
    try {
      ...
      await electrumClient.connectToUri(node.uri, settingsStore);
