...
import 'package:ew_evm/evm_chain_client.dart';
import 'package:ew_evm/evm_chain_exceptions.dart';
...
import 'package:ew_evm/evm_chain_wallet_addresses.dart';
...
abstract class EVMChainWalletBase
  ...
  EVMChainWalletBase({
    ...
    if (!EliteHive.isAdapterRegistered(Erc20Token.typeId)) {
      EliteHive.registerAdapter(Erc20TokenAdapter());
    }
