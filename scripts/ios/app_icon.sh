...
case $APP_IOS_TYPE in
	"monero.sc")
	ICON_120_PATH=`pwd`/../../assets/images/monero.sc_icon_120.png
	ICON_180_PATH=`pwd`/../../assets/images/monero.sc_icon_180.png
	ICON_1024_PATH=`pwd`/../../assets/images/monero.sc_icon_1024.png;;
	"elitewallet")
	ICON_120_PATH=`pwd`/../../assets/images/elitewallet_icon_120.png
    ICON_180_PATH=`pwd`/../../assets/images/elitewallet_icon_180.png
    ICON_1024_PATH=`pwd`/../../assets/images/elitewallet_icon_1024.png;;
    "haven")
	ICON_120_PATH=`pwd`/../../assets/images/elitewallet_icon_120.png
    ICON_180_PATH=`pwd`/../../assets/images/elitewallet_icon_180.png
    ICON_1024_PATH=`pwd`/../../assets/images/elitewallet_icon_1024.png;;
