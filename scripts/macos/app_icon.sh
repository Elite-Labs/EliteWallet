...
case $APP_MACOS_TYPE in
	...
	"elitewallet")
	ICON_16_PATH=`pwd`/../../assets/images/macos_icons/elitewallet_macos_icons/elitewallet_macos_16.png
	ICON_32_PATH=`pwd`/../../assets/images/macos_icons/elitewallet_macos_icons/elitewallet_macos_32.png
	ICON_64_PATH=`pwd`/../../assets/images/macos_icons/elitewallet_macos_icons/elitewallet_macos_64.png
	ICON_128_PATH=`pwd`/../../assets/images/macos_icons/elitewallet_macos_icons/elitewallet_macos_128.png
	ICON_256_PATH=`pwd`/../../assets/images/macos_icons/elitewallet_macos_icons/elitewallet_macos_256.png
	ICON_512_PATH=`pwd`/../../assets/images/macos_icons/elitewallet_macos_icons/elitewallet_macos_512.png
	ICON_1024_PATH=`pwd`/../../assets/images/macos_icons/elitewallet_macos_icons/elitewallet_macos_1024.png;;
esac
